package YaoGC;
public class MAX_2L_L_Weijie extends CompositeCircuit
{
	private final int L;
	public MAX_2L_L_Weijie(int L)
	{
		super(2*L, L, 2, "MAX_2L_L_2*L");
		this.L = L;
	}
	...
	protected void connectWires() 
	{
		...
		{
			inputWires[0+L+j*1].connectTo(subCircuits[1].inputWires, 0+0+j*2);
		}
		for( int j=0; j<L; j=j+1)
		{
			inputWires[0+0+j*1].connectTo(subCircuits[1].inputWires, 0+1+j*2);
		}
		for( int j=0; j<L; j=j+1)
		{
